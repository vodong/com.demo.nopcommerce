...
@Getter
public class GlobalConstantsHomePage {
	private static GlobalConstantsHomePage globalInstance;

	public static synchronized GlobalConstantsHomePage getGlobalConstants() {
		if (globalInstance == null) {
			globalInstance = new GlobalConstantsHomePage();
		}
