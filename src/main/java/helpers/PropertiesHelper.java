...
public class PropertiesHelper {
    ...
    public static void setValue(String key, String keyValue) {
        try {
            ...
            System.out.println("The Configs Properties File Has Been Updated On The Link: " + linkFile);
            properties.setProperty(key, keyValue);
            properties.store(out, null);
            out.close();
        } catch (Exception e) {
            System.out.println("The Configs Properties File Can't Save The Information. Please Check The URL: " + e.getMessage());
        }
    }
}
